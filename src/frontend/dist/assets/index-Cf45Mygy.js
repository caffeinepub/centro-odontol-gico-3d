      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 right-4 z-10 flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomIn, { size: 18 })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomOut, { size: 18 })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-5 left-1/2 -translate-x-1/2 text-white/70 text-sm font-body", children: [
              current + 1,
              " / ",
              images.length
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 p-4 overflow-x-auto max-w-full", children: images.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 h-16 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                "data-ocid": "nav-logo",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-[#00AEEF] flex items-center justify-center shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaTooth, { className: "text-white text-lg" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-white text-sm leading-none block", children: "COD 3D" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00AEEF] text-[10px] leading-none font-body", children: "Implantes" })
                  ] })
                ]
              }
            ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-[#0d1a2a]/90 via-[#0d1a2a]/60 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 pt-20 pb-12 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 bg-[#00AEEF]/20 border border-[#00AEEF]/40 rounded-full text-[#00AEEF] text-xs font-body mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-4xl md:text-5xl lg:text-6xl leading-tight mb-6", children: [
                "Centro Odontológico",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00AEEF]", children: "Digital 3D" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "Implantes"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-lg md:text-xl font-body mb-8 max-w-lg", children: "Tecnología de vanguardia para tu mejor sonrisa. Especialistas en implantología, rehabilitación oral y ortodoncia." }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-6 mt-10", children: [
                {
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 16, "aria-hidden": "true" }),
                  val: "+2000",
                  label: "Pacientes satisfechos"
                },
                {
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { size: 16, "aria-hidden": "true" }),
                  val: "+15",
                  label: "Años de experiencia"
                },
                {
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 16, "aria-hidden": "true" }),
                  val: "2",
                  label: "Especialistas"
                }
              ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00AEEF]", children: s.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-white text-lg leading-none", children: s.val }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/50 text-xs font-body", children: s.label })
                ] })
              ] }, s.label)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[#00AEEF] text-xs font-body mb-1 font-semibold uppercase tracking-wide", children: "Director Médico" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-white text-base leading-snug mb-1", children: "Dr. Leonard Walter Huamani Díaz" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs font-body", children: "Especialista en Rehabilitación Oral & Periodoncia" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-white/10 grid grid-cols-3 gap-2 text-center", children: [
                    { val: "FAIPE", label: "Brasil" },
                    { val: "UIGV", label: "Periodoncia" },
                    { val: "UPCH", label: "Maestría" }
                  ].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 rounded-lg p-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-[#00AEEF] text-sm", children: c.val }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/50 text-[10px] font-body", children: c.label })
                  ] }, c.label)) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              "aria-hidden": "true",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body", children: "Desplázate" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-gradient-to-b from-white/30 to-transparent animate-pulse" })
              ]
            }
          )
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "servicios", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 bg-[#00AEEF]/10 rounded-full text-[#00AEEF] text-xs font-body mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaTooth, { size: 12, "aria-hidden": "true" }),
          " Nuestros Servicios"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl md:text-4xl text-foreground mb-4", children: "Atención Especializada" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body max-w-xl mx-auto", children: "Ofrecemos una amplia gama de tratamientos dentales con la más avanzada tecnología digital 3D" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: SERVICES.map((svc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg mb-2", children: svc.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-body leading-relaxed", children: svc.desc })
          ]
        },
        svc.title
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "clinica", className: "py-20 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 bg-[#00AEEF]/10 rounded-full text-[#00AEEF] text-xs font-body mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaTooth, { size: 12, "aria-hidden": "true" }),
          " Nuestra Clínica"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl md:text-4xl text-foreground mb-5", children: [
          "Centro Odontológico",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00AEEF]", children: "Digital 3D" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body leading-relaxed mb-6", children: "Contamos con la más moderna infraestructura tecnológica para brindarte diagnósticos precisos y tratamientos de vanguardia. Nuestro equipo de especialistas combina experiencia clínica con innovación digital para garantizar los mejores resultados." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "casos", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 bg-[#00AEEF]/10 rounded-full text-[#00AEEF] text-xs font-body mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 12, "aria-hidden": "true" }),
          " Resultados Reales"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl md:text-4xl text-foreground mb-4", children: "Casos de Éxito" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body max-w-xl mx-auto", children: "Transformaciones reales de nuestros pacientes. Haz clic en cualquier imagen para verla en detalle con zoom." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3", children: GALLERY_IMAGES.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "equipo", className: "py-20 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 bg-[#00AEEF]/10 rounded-full text-[#00AEEF] text-xs font-body mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 12, "aria-hidden": "true" }),
          " Nuestro Equipo"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl md:text-4xl text-foreground mb-4", children: "Equipo Médico" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body max-w-xl mx-auto", children: "Especialistas altamente capacitados comprometidos con tu salud bucal" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-3xl p-8 mb-8 shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-8 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center lg:items-start", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center lg:text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[#00AEEF] text-xs font-body font-semibold uppercase tracking-wide mb-1", children: "Director Médico" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-bold text-xl text-foreground leading-snug", children: [
              "Dr. Leonard Walter",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Huamani Díaz"
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-4 text-lg", children: "Credenciales y Formación" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: [
            ...
            "li",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", "aria-hidden": "true", children: c.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-body text-foreground", children: c.text })
              ]
            },
            c.text
          )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-3xl p-8 shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-8 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center lg:items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-48 h-56 rounded-2xl bg-gradient-to-br from-[#00AEEF]/20 to-[#1a2332]/40 flex items-center justify-center mb-4 border-4 border-[#00AEEF]/20 shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              FaTooth,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs font-body", children: "Esp. Sally Arroyo Saavedra" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center lg:text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[#00AEEF] text-xs font-body font-semibold uppercase tracking-wide mb-1", children: "Especialista" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-bold text-xl text-foreground leading-snug", children: [
              "Esp. Sally Arroyo",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Saavedra"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-body mt-1", children: "Ortodoncia y Ortopedia Maxilar" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-4 text-lg", children: "Casos Clínicos de Ortodoncia" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-3", children: SALLY_CASES.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: () => setLightbox({ images: SALLY_CASES, index: i }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 bg-[#00AEEF]/20 border border-[#00AEEF]/30 rounded-full text-[#00AEEF] text-xs font-body mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 12, "aria-hidden": "true" }),
              " Contáctanos"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl md:text-4xl text-white mb-4", children: "Información de Contacto" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 font-body max-w-xl mx-auto", children: "Estamos listos para atenderte. Visítanos o comunícate con nosotros para agendar tu cita." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6 mb-12", children: [
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 24, "aria-hidden": "true" }),
              title: "Dirección",
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-[#00AEEF]/20 flex items-center justify-center text-[#00AEEF] mx-auto mb-4", children: item.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-white mb-2", children: item.title }),
                item.lines.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 font-body text-sm", children: l }, l))
              ]
            },
            item.title
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 36, className: "text-[#00AEEF]", "aria-hidden": "true" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-white", children: "Jr Jorge Aprile 552, San Borja" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-4", children: [
            ...
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FaYoutube, { size: 20 }), label: "YouTube", href: "#" },
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiTiktok, { size: 20 }),
              label: "TikTok",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[#06101a] py-6 border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-[#00AEEF] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaTooth, { className: "text-white text-sm", "aria-hidden": "true" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-white text-sm", children: "Centro Odontológico Digital 3D Implantes" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/40 text-xs font-body text-center", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Centro Odontológico Digital 3D Implantes. Built with love using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaWhatsapp, { size: 28 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
